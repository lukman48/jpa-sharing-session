...
public class EmployeeServiceImplTest {
    ...
    @Before
    public void setUp() {
        EmployeeIdentity employeeIdentity= new EmployeeIdentity(UUID.randomUUID().toString(),UUID.randomUUID().toString());
        Employee alex = new Employee(employeeIdentity,"alex","alex@testing.co.id","82123456");
